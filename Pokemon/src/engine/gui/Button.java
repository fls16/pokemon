...
public class Button extends Label {
	...
	public Button(String text, float x, float y, float width, float height) {
		...
		this.onEntered = () -> System.out.println("Button {" + this + "} entered!");
		this.onClicked = () -> System.out.println("Button {" + this + "} clicked!");
		this.onReleased = () -> System.out.println("Button {" + this + "} released!");
