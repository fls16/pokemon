...
public class Camera {
    ...
    // temp
    private Matrix4f tempProjection = new Matrix4f();

    public Matrix4f getProjection() {
	tempProjection.setIdentity();
	tempProjection.m30 = position.x;
	tempProjection.m31 = position.y;
	return Matrix4f.mul(projection, tempProjection, tempProjection);
    }
